package com.clinicalsystem.analytics.controller;
...
import com.clinicalsystem.analytics.service.AnalyticsService;
...
public class AnalyticsController {
    ...
    public ResponseEntity<ApiResponse<AppointmentAnalyticsResponse>> getAppointmentAnalytics(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                analyticsService.getAppointmentAnalytics(from, to, doctorId)));
    }
